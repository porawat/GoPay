      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-6 sm:p-8">
        <div className="bg-gradient-to-r from-indigo-600 to-blue-700 px-6 py-4 rounded-t-lg">
          ...
          <p className="text-indigo-100 mt-1 text-sm">
            กรอกข้อมูลให้ครบถ้วนในช่องที่มีเครื่องหมาย <span className="text-red-300">*</span>
          </p>
        </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-3">
                <label className="flex items-center p-2 rounded hover:bg-gray-100 transition-colors">
                  ...
                  <span className="ml-2 text-gray-700">
                    ...
                    <span className="text-xs block text-gray-500">จัดการการขายและออกใบเสร็จ</span>
                  </span>
                </label>
                <label className="flex items-center p-2 rounded hover:bg-gray-100 transition-colors">
                  <input
                  ...
                  <span className="ml-2 text-gray-700">
                    ...
                    <span className="text-xs block text-gray-500">ดูแลสินค้าและสต็อก</span>
                  </span>
                </label>
                <label className="flex items-center p-2 rounded hover:bg-gray-100 transition-colors">
                  <input
                  ...
                  <span className="ml-2 text-gray-700">
                    ...
                    <span className="text-xs block text-gray-500">สิทธิ์สูงสุดในการจัดการร้าน</span>
                  </span>
                </label>
              </div>
              {errors.roles && (
